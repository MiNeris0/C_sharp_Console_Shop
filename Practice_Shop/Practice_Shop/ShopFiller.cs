...
namespace Practice_Shop
{
    ...
    {
        private static ShopFiller _instance = new ShopFiller();
        ...
        public static ShopFiller Instance => _instance;
        ...
        public void GetProduct(int i, ref Product prod)
        {
            prod.ProductName = _names[i];
            prod.Type = _types[i];
            prod.ProductDescription = _descriptions[i];
            prod.Price = _prices[i];
            prod.ProductId = _id[i];
        }
